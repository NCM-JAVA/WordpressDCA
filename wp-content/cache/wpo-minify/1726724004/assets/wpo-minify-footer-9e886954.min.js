...
current_modifier=calculated_modifier;let e_index=0;$.each(wpavefrsz.elements,function(index,item){$(wpavefrsz.main_selector+' '+item).add(wpavefrsz.include_selectors).not(wpavefrsz.exclude_selectors).each(function(){let font_size=parseFloat($(this).css('font-size'));if(!flag){initial_sizes[e_index]=font_size}
