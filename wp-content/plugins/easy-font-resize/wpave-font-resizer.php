...
function wpavefrsz_output_resizer($position = '') {
	...
	$html .= '<span class="wpavefrsz-minus' . esc_attr($notranslate_class) . '" tabindex="0" aria-label="' . esc_attr(get_option('wpavefrsz_text_decrease')) . '" title="' . esc_attr(get_option('wpavefrsz_text_decrease')) . '" role="button">' . ($use_icons === true ? 'A-' : wp_kses_post($minus)) . '</span>';

	
	$html .= '<span class="wpavefrsz-plus' . esc_attr($notranslate_class) .'" tabindex="0" aria-label="' . esc_attr(get_option('wpavefrsz_text_increase')) . '" title="' . esc_attr(get_option('wpavefrsz_text_increase')) . '" role="button">' . ($use_icons === true ? 'A+' :  wp_kses_post($plus)) . '</span>';
	
	$html .= '<span class="wpavefrsz-reset' . esc_attr($notranslate_class) .'" tabindex="0" aria-label="' . esc_attr(get_option('wpavefrsz_text_reset')) . '" title="' . esc_attr(get_option('wpavefrsz_text_reset')) . '" role="button">' .($use_icons === true ? 'A' : wp_kses_post($equals)) . '</span>';
