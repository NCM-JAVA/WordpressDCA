...
/* @overview/index.twig */
class __TwigTemplate_90599fdfd105bcac7a4486137e5e34abf1fe7651479878cf5fb7af9dfdae2069 extends Twig_SupTwgSgg_Template
{
...
\t\t\t\t\t\tLearn more about it in <a href=\"//supsystic.com/main-settings/\" target=\"_blank\">Main Settings.</a>
        ...
        if (($this->getAttribute(($context["environment"] ?? null), "isPro", array(), "method") == false)) {
            // line 212
            echo "            <a href=\"https://supsystic.com/?mod=user&action=addToCart&pid=23284&addQty=1&goto=checkout&lang=en\" target=\"_blank\"><img class=\"overview-supsystic-img\" src=\"";
            echo Twig_SupTwgSgg_escape_filter($this->env, ($context["SGG_PLUGIN_URL"] ?? null), "html", null, true);
            echo "/src/GridGallery/Overview/assets/img/overview-trial.png\"></a>";
        }
        // line 214
    ...
    {
        return new Twig_SupTwgSgg_Source("", "@overview/index.twig", "C:\\xampp\\htdocs\\wordpress\\wp-content\\plugins\\gallery-by-supsystic\\src\\GridGallery\\Overview\\views\\index.twig");
    }
}
